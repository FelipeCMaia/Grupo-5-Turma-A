...
public class App {
	...
	public static void ExibirTextoFases(int fase, boolean correto) throws Exception {		
		switch (fase) {
			...
			case 2:
			if(correto) {
				Utilitarios.ExibirTexto("Após uma árdua batalha, finalmente o guardião cai e todas suas peças começam a entrar em curto circuito, afirmando sua derrota. \n"
			...
			case 3:
			if(correto) {
				Utilitarios.ExibirTexto("Você cai de joelhos, perante o grande robô a sua frente, depois da longínqua batalha você ver um único robô em pé, \n"
				...
				Utilitarios.ExibirTexto("Você cai de joelhos, perante o grande robô a sua frente, a condenação para humanidade está próxima, "
